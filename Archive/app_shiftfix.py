...
if st.button("Run Burndown Simulation"):
    ...
    ax1.plot(df_reduced["Month"], df_reduced["NANC_Backlog"], marker='o', label="Non-Actionable Non-Certified Backlog")
    ax1.plot(df_reduced["Month"], df_reduced["ANC_Backlog"], marker='o', label="Actionable Non-Certified Backlog")
    ...
    add_labels(ax1, df_reduced["Month"], df_reduced["NANC_Backlog"], step=3)
    add_labels(ax1, df_reduced["Month"], df_reduced["ANC_Backlog"], step=3)
